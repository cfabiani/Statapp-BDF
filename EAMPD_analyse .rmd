...
monetary_event["date"]<-ymd(monetary_event$date) monetary_event["year"] <- year(monetary_event$date)
monetary_event["month"] <-month(monetary_event$date) monetary_event["day"] <- day(monetary_event$date)
...
```{r}
# Evolution temporelle des annonces de taux
